const ramos = [
  ...
  { nombre: "Administración y Gestión Farmacéutica", semestre: "VIII Semestre", desbloquea: ["Práctica Profesional en Farmacia Comunitaria", "Farmacia Asistencial", "Economía en Salud y Marketing Farmacéutico"] },
  { nombre: "Estadística Farmacéutica", semestre: "VIII Semestre", desbloquea: ["Innovación y proyectos"] },

  { nombre: "Farmacología Clínica", semestre: "IX Semestre", desbloquea: ["Práctica Profesional en Farmacia Comunitaria", "Actividad final de titulación", "Farmacia Clínica"] },
  { nombre: "Bromatología", semestre: "IX Semestre", desbloquea: [] },
  { nombre: "Toxicología", semestre: "IX Semestre", desbloquea: ["Práctica Profesional en Farmacia Comunitaria"] },
